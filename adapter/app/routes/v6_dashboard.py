...
Read-only V6 dashboard (plan section 8).
    ...
    GET /v6/static/v6.js     the page script, served from app/static
...
from ..v6.container import APP_STATE_KEY
from ..v6.dashboard_queries import OverviewState, build_overview, read_tables
